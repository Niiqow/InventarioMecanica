...
<div class="container">
      ...
      <a class="btn btn-primary" href="{{ route('ingMVSFisica.index') }}">Volver</a>
            </div>
...
<form action="{{ route('ingMVSFisica.store') }}" method="POST">
    @csrf
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
          <div class="form-group">
             ...
             <select class="form-control" type="text" name="clasificacion" class="form-control" placeholder="Clasificación">
