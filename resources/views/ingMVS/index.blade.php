...
<h4>• Especificación técnica detallada: entrega información adicional que permite precisar las características que debe tener el equipo, <h4>por ejemplo, precisión, requisitos técnicos, etc.</h4>
...
<h4>Durante la planificación académica, la Sede podrá implementar un mayor número de secciones en la medida en que se utilicen los equipos en distintos bloques horarios. Para aquellos casos en que la Sede, por cantidad de alumnos y/o disponibilidad de instalaciones, no pueda operar adecuadamente con el estándar básico definido, podrá gestionar la adquisición de mayor cantidad de equipos, justificándolos adecuadamente durante la formulación de proyectos de inversión. </h4>
...
La valorización de insumos es considerando precios Región Metropolitana. No considera eventuales costos de transporte.</h4>
