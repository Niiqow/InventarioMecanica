...
<div class="text-center">
        <a class="btn btn-primary" href="{{ route('ingMVSEquipos.index') }}">Equipos</a>
        <a class="btn btn-primary" href="{{ route('ingMVSInsumos.index') }}">Insumos</a>
        <a class="btn btn-primary" href="{{ route('ingMVSEquiposA.index') }}">Equipos Año</a>
        <a class="btn btn-primary" href="{{ route('ingMVSRelacion.index') }}">Relación Asig</a>
        <a class="btn btn-primary" href="{{ route('ingMVSFisica.index') }}">Física Mecánica</a>
</div>
...
<table class="table">
    ...
    <tr>
      ...
      <td><h4>Ingeniería en Maquinaria, Vehículos Automotrices y Sistemas Electrónicos</h4></td>
    </tr>
    <tr>
      <td><h4>Mención</h4></td>
...
<h4>El Estándar de Equipamiento especificado en la hoja “Equipos”, está compuesto varias columnas, las que caracterizan al equipo y entregan datos de valorización para apoyar la implementación del equipamiento en Sede. A continuación se describen las columnas del formato:</h4>
  ...
  <h4>Durante la planificación académica, la Sede podrá implementar un mayor número de secciones en la medida en que se utilicen los equipos en distintos bloques horarios. Para aquellos casos en que la Sede, por cantidad de alumnos y/o disponibilidad de instalaciones, no pueda operar adecuadamente con el estándar básico definido, podrá gestionar la adquisición de mayor cantidad de equipos, justificándolos adecuadamente durante la formulación de proyectos de inversión. Asimismo, si la cantidad de equipos señalada en el estándar no es posible instalarla en la sede, podrá contar con una cantidad inferior, reduciendo, proporcionalmente el número de alumnos de la actividad.</h4>
  ...
  <h4>Esta actualización no se considera como cambio del Estándar de Equipamiento, pues sólo corresponde a la definición de una alternativa de compra cuando el equipo originalmente considerado no está disponible.</h4>
  <h4>Por consiguiente, no afectará a las Sedes que ya dispongan del equipo.</h4>
  ...
  <h4>La valorización de insumos es considerando precios Región Metropolitana. No considera eventuales costos de transporte.</h4>
